...
class CaseTest {
    ...
    @Test
    void testToString() {
        assertEquals("Case 1 to be found 0 / 111111111 / 123456789 |", maCase.toString());
        maCase.setCaseTrouvee(3);
        assertEquals("Case 1 found 3 / 001000000 / 3 |", maCase.toString());
        maCase.setCaseInitiale(7);
        assertEquals("Case 1 initial 7 / 000000100 / 7 |", maCase.toString());
